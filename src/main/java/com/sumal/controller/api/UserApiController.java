...
import com.sumal.dto.user.UserCreateRequest;
import com.sumal.dto.user.UserPasswordUpdateRequest;
import com.sumal.dto.user.UserResponse;
import com.sumal.dto.user.UserUpdateRequest;
...
public class UserApiController {
  ...
  @PreAuthorize("isAuthenticated() && (hasAuthority('ROLE_ADMIN') || (#userId == authentication.principal.userId))")
  @GetMapping("/{id}")
  @SecurityRequirement(name = OpenApiConstants.TOKEN_SECURITY_REQUIREMENT)
